...
function getAnalyzeInferencePrompt(args) {
...
function getOptimizeCostsPrompt(args) {
...
function getDetectDriftPrompt(args) {
...
function getBenchmarkComparisonPrompt(args) {
